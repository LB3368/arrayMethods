...
// CODE HERE
const evenNumbers  = mixedNumbers.filter((el)=>{
  return el % 2 === 0
})
...
// CODE HERE
const postTaxPrices = prices.map(whole => whole * 1.07);
...
// CODE HERE
const totalPopulation  = populations.reduce((acc,c)=> acc + c)
...
// CODE HERE
const sumPurchases = purchases.filter(sum => sum.owner === 'Bob').reduce((acc, curr) => acc + curr.price, 0)
